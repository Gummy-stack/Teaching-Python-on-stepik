...
def inputPlayerLetter():
    # Разрешите игроку ввести букву, которую он выбирает.
...
def getComputerMove(board, computerLetter):
    # Учитывая заполнение игрового поля и букву компьютера, опеределяет допустимый ход и вовзращает его.
    if computerLetter == 'X':
        playerLetter = 'O'
    else:
        playerLetter = 'X'
...
while True:
    ...
    print('Сиграем еще раз? (да или нет)')
